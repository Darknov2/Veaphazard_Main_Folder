...
/// <summary>
/// Simplex Noise implementation (3D + optional 4D for animated effects).
/// Adapted, simplified for terrain density usage.
/// </summary>
public class SimplexNoise
{
    ...
    public SimplexNoise(int seed)
    {
        ...
        for (int i = 0; i < 256; i++) source[i] = p[i % p.Length] ^ Random.Range(0, 256);
    ...
    public float Noise(float xin, float yin, float zin)
    {
        ...
        return 32.0f * (n0 + n1 + n2 + n3); // Scale to roughly [-1,1]
    }
}