...
public class Sign : MonoBehaviour
{
    ...
    /// <summary>
    /// FMaps our Side to whatever argument type the selector's GetNeighborIndex expects (enum or int).
    /// </summary>
    ...
    private void FindAndCacheSelector()
    {
        ...
        // Use SceneFind to get all MonoBehaviours in scene (including inactive)
        var all = SceneFind.All<MonoBehaviour>(includeInactive: true);
